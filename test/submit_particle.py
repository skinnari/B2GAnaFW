...
def getOptions() :
    ...
    parser.add_option("-c", "--config", dest="cfg", default="b2gedmntuples_particleLevel_cfg.py",
...
def main():
    ...
    for ijob, job in enumerate(jobs) :
        ...
        print requestname
        config.General.requestName = requestname + '_PL'
	...
	if options.outLFNDirBase and not options.outLFNDirBase.isspace(): 
        ...
        config.Data.outputDatasetTag = cond+'_'+options.version + '_PL'
