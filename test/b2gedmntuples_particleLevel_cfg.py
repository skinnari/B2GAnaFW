...
ak8Cut='pt > 300 && abs(eta) < 2.4'
ak4Cut='pt > 40 && abs(eta) < 2.4'
...
# particle-level information a la RIVET version of pseudo-top
...
process.recoFilter = cms.EDFilter("CandViewCountFilter",
...
process.partonSelector = cms.EDFilter("CandViewSelector",
    src = cms.InputTag("prunedGenParticles"),
    cut = cms.string("abs(pdgId) == 6 && pt > 350.0")
)      
process.partonFilter = cms.EDFilter("CandViewCountFilter",
    src = cms.InputTag("partonSelector"),
    minNumber = cms.uint32(1),
    filter = cms.bool(True)
)      
...
process.filterPath2 = cms.Path(
    process.particleFilter
)
process.filterPath3 = cms.Path(
